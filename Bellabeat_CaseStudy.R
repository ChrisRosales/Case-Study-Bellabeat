...
daily_activity <- read.csv("C:/Users/ASUS/Downloads/Bellabeat_Project/dailyActivity_merged.csv")

# Create another dataframe for the sleep data.
sleep_day <- read.csv("C:/Users/ASUS/Downloads/Bellabeat_Project/sleepDay_merged.csv")
#########################
